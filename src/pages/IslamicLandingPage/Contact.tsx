            ...
            <form className="space-y-5">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="group">
                  ...
                  <input
                    type="text"
                    className="w-full px-5 py-3 rounded-lg border-2 border-emerald-100/60 bg-white hover:border-emerald-300 focus:border-emerald-500 focus:outline-none transition-all duration-300 text-slate-800 placeholder-slate-400"
